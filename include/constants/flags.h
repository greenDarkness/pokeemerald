...
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_FLUFFY_TAIL         (FLAG_HIDDEN_ITEMS_START + 0x70)
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_HEAL_POWDER         (FLAG_HIDDEN_ITEMS_START + 0x71)
...
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_HARD_STONE          (FLAG_HIDDEN_ITEMS_START + 0x78)
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_BIG_PEARL_1         (FLAG_HIDDEN_ITEMS_START + 0x79)
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_BIG_PEARL_2         (FLAG_HIDDEN_ITEMS_START + 0x7A)
