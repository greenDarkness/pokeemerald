...
extern const u8 gText_Oak_ThisIsAPokemon[];
...
extern const u8 gText_Elm_Welcome[];
extern const u8 gText_Elm_ThisIsAPokemon[];
extern const u8 gText_Elm_MainSpeech[];
extern const u8 gText_Elm_AndYouAre[];
extern const u8 gText_Elm_YourePlayer[];
extern const u8 gText_Elm_AreYouReady[];
...
extern const u8 gText_IPColon[];
extern const u8 gText_APColon[];
...
extern const u8 gText_ExpAllEnabled[];
extern const u8 gText_ExpAllDisabled[];
...
extern const u8 gText_DextrackerCheck[];
extern const u8 gText_DextrackerClear[];
extern const u8 gText_DextrackerEnable[];
extern const u8 gText_DextrackerDisable[];
extern const u8 gText_DextrackerCancel[];
extern const u8 gText_DextrackerChainInfo[];
extern const u8 gText_DextrackerChainInfoMax[];
extern const u8 gText_DextrackerNoChain[];
extern const u8 gText_DextrackerCleared[];
extern const u8 gText_DextrackerEnabled[];
extern const u8 gText_DextrackerDisabled[];
