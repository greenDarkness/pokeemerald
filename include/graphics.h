...
extern const u32 gTrainerFrontPic_Policeman[];
...
// Johto trainer palettes (ported from pokesequel)
...
extern const u32 gTrainerPalette_Policeman[];
...
extern const u32 gItemIcon_RepellentFog[];
extern const u32 gItemIconPalette_RepellentFog[];
