...
extern const u8 BattleScript_SmokeCloakEscape[];
...
extern const u8 BattleScript_ExpShareLevelUp[];
extern const u8 BattleScript_ExpShareLevelUpTeam[];
extern const u8 BattleScript_ExpShareLevelUpGroup[];
...
extern const u8 BattleScript_BallTooPowerful[];
