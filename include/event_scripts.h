...
extern const u8 EventScript_DebtGrunt[];
...
extern const u8 RustboroCity_DevonCorp_3F_EventScript_MrStoneCall[];
...
extern const u8 LittlerootTown_EventScript_WaterSudowoodo[];
...
extern const u8 PkmnCenter_EventScript_RegisterCorbeau[];
