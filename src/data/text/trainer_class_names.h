const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_PLAYER] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_RIVAL_EARLY] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_RIVAL_LATE] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_ROCKER] = _("ROCKER"),
    [TRAINER_CLASS_KANTO_LEADER] = _("LEADER"),
    [TRAINER_CLASS_KANTO_ELITE_FOUR] = _("ELITE FOUR"),
