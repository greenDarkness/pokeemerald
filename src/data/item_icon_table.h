const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_GEO_DUD] = {gItemIcon_GeoDud, gItemIconPalette_GeoDud},
    [ITEM_PAY_ROLL] = {gItemIcon_PayRoll, gItemIconPalette_PayRoll},
    [ITEM_REPELLENT_FOG] = {gItemIcon_RepellentFog, gItemIconPalette_RepellentFog},
    [ITEM_EXP_ALL] = {gItemIcon_ExpAll, gItemIconPalette_ExpAll},
