...
void ItemUseOutOfBattle_LuckyDozen(u8 taskId)
{
    ...
    {
        FlagClear(FLAG_SYS_LUCKY_DOZEN_ENABLED);
        text = gText_LuckyDozenDisabled;
    }
    else
    {
        FlagSet(FLAG_SYS_LUCKY_DOZEN_ENABLED);
        text = gText_LuckyDozenEnabled;
    }
...
void ItemUseOutOfBattle_BondingChime(u8 taskId)
{
    ...
    {
        FlagClear(FLAG_SYS_BONDING_CHIME_ENABLED);
        text = gText_BondingChimeDisabled;
    }
    else
    {
        FlagSet(FLAG_SYS_BONDING_CHIME_ENABLED);
        text = gText_BondingChimeEnabled;
    }
...
void ItemUseOutOfBattle_PayRoll(u8 taskId)
{
    ...
    {
        FlagClear(FLAG_SYS_PAY_ROLL_ENABLED);
        text = gText_PayRollDisabled;
    }
    else
    {
        FlagSet(FLAG_SYS_PAY_ROLL_ENABLED);
        text = gText_PayRollEnabled;
    }
...
void ItemUseOutOfBattle_RepellentFog(u8 taskId)
{
    ...
    {
        FlagClear(FLAG_SYS_REPELLENT_FOG_ENABLED);
        text = gText_RepellentFogDisabled;
    }
    else
    {
        FlagSet(FLAG_SYS_REPELLENT_FOG_ENABLED);
        text = gText_RepellentFogEnabled;
    }
