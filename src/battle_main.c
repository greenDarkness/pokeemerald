...
// Forward declaration from wild_encounter.c
...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_AROMA_LADY, 20},
    {TRAINER_CLASS_RUIN_MANIAC, 30},
    {TRAINER_CLASS_INTERVIEWER, 24},
    {TRAINER_CLASS_TUBER_F, 2},
    {TRAINER_CLASS_TUBER_M, 2},
    {TRAINER_CLASS_SIS_AND_BRO, 6},
    {TRAINER_CLASS_COOLTRAINER, 24},
    {TRAINER_CLASS_HEX_MANIAC, 12},
    {TRAINER_CLASS_LADY, 100},
    {TRAINER_CLASS_BEAUTY, 40},
    {TRAINER_CLASS_RICH_BOY, 100},
    {TRAINER_CLASS_POKEMANIAC, 30},
    {TRAINER_CLASS_SWIMMER_M, 4},
    {TRAINER_CLASS_BLACK_BELT, 16},
    ...
    {TRAINER_CLASS_PSYCHIC, 12},
    {TRAINER_CLASS_GENTLEMAN, 40},
    {TRAINER_CLASS_ELITE_FOUR, 50},
    {TRAINER_CLASS_LEADER, 50},
    {TRAINER_CLASS_KANTO_ELITE_FOUR, 50},
    {TRAINER_CLASS_KANTO_LEADER, 50},
    ...
    {TRAINER_CLASS_KANTO_CHAMPION, 100},
    {TRAINER_CLASS_FISHERMAN, 20},
    {TRAINER_CLASS_TRIATHLETE, 20},
    {TRAINER_CLASS_DRAGON_TAMER, 24},
    {TRAINER_CLASS_BIRD_KEEPER, 16},
    {TRAINER_CLASS_NINJA_BOY, 6},
    {TRAINER_CLASS_BATTLE_GIRL, 12},
    {TRAINER_CLASS_PARASOL_LADY, 20},
    {TRAINER_CLASS_SWIMMER_F, 4},
    {TRAINER_CLASS_PICNICKER, 8},
    {TRAINER_CLASS_TWINS, 6},
    {TRAINER_CLASS_SAILOR, 16},
    {TRAINER_CLASS_COLLECTOR, 30},
    {TRAINER_CLASS_RIVAL, 30},
    {TRAINER_CLASS_PKMN_BREEDER, 20},
    {TRAINER_CLASS_PKMN_RANGER, 24},
    {TRAINER_CLASS_TEAM_MAGMA, 10},
    {TRAINER_CLASS_MAGMA_ADMIN, 20},
    {TRAINER_CLASS_MAGMA_LEADER, 40},
    {TRAINER_CLASS_LASS, 8},
    {TRAINER_CLASS_BUG_CATCHER, 8},
    {TRAINER_CLASS_HIKER, 20},
    {TRAINER_CLASS_YOUNG_COUPLE, 16},
    {TRAINER_CLASS_WINSTRATE, 20},
    // Kanto trainer classes
    {TRAINER_CLASS_CHANNELER, 12},
    {TRAINER_CLASS_BURGLAR, 30},
    {TRAINER_CLASS_JUGGLER, 18},
    {TRAINER_CLASS_TAMER, 24},
    {TRAINER_CLASS_SUPER_NERD, 12},
    {TRAINER_CLASS_CUE_BALL, 16},
    {TRAINER_CLASS_ENGINEER, 24},
    {TRAINER_CLASS_BOSS, 100},
    {TRAINER_CLASS_TEAM_ROCKET, 10},
    {TRAINER_CLASS_SCIENTIST, 24},
    {TRAINER_CLASS_BIKER, 16},
    {TRAINER_CLASS_COOL_COUPLE, 24},
    {TRAINER_CLASS_CRUSH_GIRL, 16},
    {TRAINER_CLASS_BOARDER, 10},
    {TRAINER_CLASS_CRUSH_KIN, 16},
    {TRAINER_CLASS_GAMER, 36},
    {TRAINER_CLASS_PAINTER, 24},
    {TRAINER_CLASS_PKMN_PROF, 100},
    {TRAINER_CLASS_PLAYER, 30},
    {TRAINER_CLASS_RIVAL_EARLY, 20},
    {TRAINER_CLASS_RIVAL_LATE, 30},
    {TRAINER_CLASS_ROCKER, 16},
    {0xFF, 10}, // Any trainer class not listed above uses this
};
