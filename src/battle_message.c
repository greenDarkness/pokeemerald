...
static const u8 sText_PartyGainedEXP[] = _("The rest of the party gained EXP.!\p");
...
const u8 gText_PkmnsItemRestoredStatus[] = _("{B_ATK_NAME_WITH_PREFIX} restored\nits status!");
...
static const u8 sText_PlayerFledUsingSmokecloak[] = _("{PLAY_SE SE_FLEE}{B_PLAYER_NAME} fled using\nthe SMOKE CLOAK!\p");
...
static const u8 sText_WildTooPowerful[] = _("It's no use!\nThe wild {B_OPPONENT_MON1_NAME} is too powerful!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_WILD_TOO_POWERFUL - BATTLESTRINGS_TABLE_START] = sText_WildTooPowerful,
    ...
    [STRINGID_PLAYERFLEDUSINGSMOKECLOAK - BATTLESTRINGS_TABLE_START] = sText_PlayerFledUsingSmokecloak,
...
const u8 gText_WhatWillOldManDo[] = _("What will\nOLD MAN do?");
