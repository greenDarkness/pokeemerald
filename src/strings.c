...
const u8 gText_StartPC[] = _("START");
...
const u8 gText_IPColon[] = _("IP:");
const u8 gText_APColon[] = _("AP:");
...
const u8 gText_ExpAllEnabled[] = _("EXP. ALL turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpAllDisabled[] = _("EXP. ALL turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_MachoGearEnabled[] = _("MACHO GEAR turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_MachoGearDisabled[] = _("MACHO GEAR turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_SmokeCloakEnabled[] = _("SMOKE CLOAK turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_SmokeCloakDisabled[] = _("SMOKE CLOAK turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_LuckyDozenEnabled[] = _("LUCKY DOZEN turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_LuckyDozenDisabled[] = _("LUCKY DOZEN turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_BondingChimeEnabled[] = _("BONDING CHIME turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_BondingChimeDisabled[] = _("BONDING CHIME turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_GeoDudEnabled[] = _("GEO DUD turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_GeoDudDisabled[] = _("GEO DUD turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_PayRollEnabled[] = _("PAY ROLL turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_PayRollDisabled[] = _("PAY ROLL turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepellentFogEnabled[] = _("REPELLENT FOG turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepellentFogDisabled[] = _("REPELLENT FOG turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_DextrackerCheck[] = _("CHECK");
const u8 gText_DextrackerClear[] = _("CLEAR");
const u8 gText_DextrackerEnable[] = _("ENABLE");
const u8 gText_DextrackerDisable[] = _("DISABLE");
const u8 gText_DextrackerCancel[] = _("CANCEL");
const u8 gText_DextrackerChainInfo[] = _("{STR_VAR_1}: Chain {STR_VAR_2}\nRerolls: {STR_VAR_3}{PAUSE_UNTIL_PRESS}");
const u8 gText_DextrackerChainInfoMax[] = _("{STR_VAR_1}: Chain {STR_VAR_2} MAX\nRerolls: {STR_VAR_3}{PAUSE_UNTIL_PRESS}");
const u8 gText_DextrackerNoChain[] = _("No chain active.{PAUSE_UNTIL_PRESS}");
const u8 gText_DextrackerCleared[] = _("Chain cleared.{PAUSE_UNTIL_PRESS}");
const u8 gText_DextrackerEnabled[] = _("DEXTRACKER turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_DextrackerDisabled[] = _("DEXTRACKER turned off.{PAUSE_UNTIL_PRESS}");
...
const u8 *const gBagMenu_ReturnToStrings[] =
{
    ...
    [ITEMMENULOCATION_BALL_SWAP]           = gText_TheField
};
...
const u8 gText_EggSlot[] = _("EGG SLOT");
...
const u8 gText_RemoveEggFromSlot[] = _("Take the EGG from the\negg slot?");
const u8 gText_EggSentToPC[] = _("The EGG was sent to\nyour PC.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoItems[] = _("There are no items in the PC.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoRoomInBag[] = _("There is no more\nroom in the BAG.");
const u8 gText_WithdrawHowManyItems[] = _("Withdraw\nhow many\n{STR_VAR_1}(s)?");
...
const u8 gText_SpinningTop[] = _("SPINNING TOP");
const u8 gText_SealTruckBox[] = _("RE-TAPE BOX");
const u8 gText_DontSealBox[] = _("LEAVE");
const u8 gText_HOPE[] = _("HOPE");
...
const u8 gText_Docile[] = _("DOCILE");
...
const u8 gText_Bashful[] = _("BASHFUL");
...
const u8 gText_1Everstone[] = _("1 EVERSTONE");
const u8 gText_10Everstones[] = _("10 EVERSTONEs");
const u8 gText_CancelEverstone[] = _("CANCEL");
const u8 gText_UsePayday[] = _("Use PAYDAY!");
const u8 gText_UseThief[] = _("Use THIEF!");
const u8 gText_UseSnatch[] = _("Use SNATCH!");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the MAP.");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INSTANT");
...
const u8 gText_Neutral[] = _("NEUTRAL");
