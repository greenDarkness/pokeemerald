// Ruby/Sapphire intro, ported from pokeruby. Shared by pairs 3 (Ruby) and 4 (Sapphire).
#include "global.h"
...
// The spinning Pok\u00e9ball sprite uses the battle-anim Pok\u00e9ball graphics.
extern const u32 gBattleAnimSpriteGfx_Pokeball[];
extern const u32 gBattleAnimSpritePal_Pokeball[];

// Random intro/title pool indices for the two versions sharing this intro.
#define RUBY_PAIR     3
#define SAPPHIRE_PAIR 4
#ifndef FADE_COLOR_WHITE
#define FADE_COLOR_WHITE RGB_WHITEALPHA
#endif
...
static const struct SpriteFrameImage sIntroPicFrameImages[] = {
    { gDecompressionBuffer + 0 * 0x800, 0x800 },
    { gDecompressionBuffer + 1 * 0x800, 0x800 },
    { gDecompressionBuffer + 2 * 0x800, 0x800 },
    { gDecompressionBuffer + 3 * 0x800, 0x800 },
    { gDecompressionBuffer + 4 * 0x800, 0x800 },
    { gDecompressionBuffer + 5 * 0x800, 0x800 },
    { gDecompressionBuffer + 6 * 0x800, 0x800 },
};
static const union AnimCmd sIntroPicAnim[] = { ANIMCMD_FRAME(0, 1), ANIMCMD_END };
static const union AnimCmd *const sIntroPicAnims[] = { sIntroPicAnim };
static const struct OamData sIntroPicOam = {
    .y = 0,
...
static EWRAM_DATA u16 gUnknown_02039358 = 0;
static EWRAM_DATA u16 gUnknown_0203935A = 0;

static u32 sIntroFrameCounter;

// BLDALPHA coefficient pairs used to fade between the battle scene layers.
static const u16 gUnknown_08393E64[] = {
...
static const u16 Palette_406340[] = INCBIN_U16("graphics/intro_rs/unknown1.gbapal");
static const u16 Palette_406360[] = INCBIN_U16("graphics/intro_rs/unknown2.gbapal");
static const u32 gIntroTiles[] = INCBIN_U32("graphics/intro_rs/intro.4bpp.lz");
static const u16 gIntro1BGPals[][16] =
{
    INCBIN_U16("graphics/intro_rs/intro1_bgpal1.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal2.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal3.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal4.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal5.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal6.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal7.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal8.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal9.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal10.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal11.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal12.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal13.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal14.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal15.gbapal"),
    INCBIN_U16("graphics/intro_rs/intro1_bgpal16.gbapal"),
};
static const u32 gIntro1BG0_Tilemap[] = INCBIN_U32("graphics/intro_rs/intro1_bg0_map.bin.lz");
static const u32 gIntro1BG1_Tilemap[] = INCBIN_U32("graphics/intro_rs/intro1_bg1_map.bin.lz");
static const u32 gIntro1BG2_Tilemap[] = INCBIN_U32("graphics/intro_rs/intro1_bg2_map.bin.lz");
static const u32 gIntro1BG3_Tilemap[] = INCBIN_U32("graphics/intro_rs/intro1_bg3_map.bin.lz");
static const u32 gIntro1BGLeavesGfx[] = INCBIN_U32("graphics/intro_rs/introgfx.4bpp.lz");
static const u16 gIntro3PokeballPal[] = INCBIN_U16("graphics/intro_rs/intro3_pokeball.gbapal");
static const u32 gIntro3Pokeball_Tilemap[] = INCBIN_U32("graphics/intro_rs/intro3_pokeball_map.bin.lz");
static const u32 gIntro3Pokeball_Gfx[] = INCBIN_U32("graphics/intro_rs/intro3_pokeball.8bpp.lz");
static const u16 gIntro3Streaks_Pal[] = INCBIN_U16("graphics/intro_rs/intro3_streaks.gbapal");
static const u32 gIntro3Streaks_Gfx[] = INCBIN_U32("graphics/intro_rs/intro3_streaks.4bpp.lz");
static const u32 gIntro3Streaks_Tilemap[] = INCBIN_U32("graphics/intro_rs/intro3_streaks_map.bin.lz");
static const u16 gIntro3Misc1Palette[] = INCBIN_U16("graphics/intro_rs/intro3_misc1.gbapal");
static const u16 gIntro3Misc2Palette[] = INCBIN_U16("graphics/intro_rs/intro3_misc2.gbapal");
static const u32 gIntro3MiscTiles[] = INCBIN_U32("graphics/intro_rs/intro3_misc.4bpp.lz");
static const u16 gIntro1EonPalette[] = INCBIN_U16("graphics/intro_rs/intro1_eon.gbapal");
static const u32 gIntro1EonTiles[] = INCBIN_U32("graphics/intro_rs/intro1_eon.4bpp.lz");
...
// Ruby/Sapphire intro pool entry point. The Emerald copyright screen has
// already run, so this jumps straight into the water-drop scene.
...
{
    if (sIntroFrameCounter > 1026)
        gTasks[taskId].func = Task_IntroLoadPart2Graphics;
}

// --- RS bike-scene player/bicycle + Latios/Latias sprites (own copies, unique tags) ---
// Unique tags to avoid collision with Emerald's intro (TAG_BICYCLE 1001 .. TAG_FLYGON_LATIAS 1005).
#define RS_TAG_BICYCLE 5001
#define RS_TAG_BRENDAN 5002
#define RS_TAG_MAY     5003
#define RS_TAG_LATIOS  5004
#define RS_TAG_LATIAS  5005

static const u16 sIntro2BrendanPalette[] = INCBIN_U16("graphics/intro_rs/intro2_brendan.gbapal");
static const u32 sIntro2BrendanTiles[]   = INCBIN_U32("graphics/intro_rs/intro2_brendan.4bpp.lz");
static const u16 sIntro2MayPalette[]     = INCBIN_U16("graphics/intro_rs/intro2_may.gbapal");
static const u32 sIntro2MayTiles[]       = INCBIN_U32("graphics/intro_rs/intro2_may.4bpp.lz");
static const u32 sIntro2BicycleTiles[]   = INCBIN_U32("graphics/intro_rs/intro2_bicycle.4bpp.lz");

static const struct CompressedSpriteSheet sSpriteSheet_Brendan[] = { { sIntro2BrendanTiles, 0x3800, RS_TAG_BRENDAN }, {} };
static const struct CompressedSpriteSheet sSpriteSheet_May[]     = { { sIntro2MayTiles, 0x3800, RS_TAG_MAY }, {} };
static const struct CompressedSpriteSheet sSpriteSheet_Bicycle[] = { { sIntro2BicycleTiles, 0x1000, RS_TAG_BICYCLE }, {} };
static const struct SpritePalette sSpritePalettes_Player[] = { { sIntro2BrendanPalette, RS_TAG_BRENDAN }, { sIntro2MayPalette, RS_TAG_MAY }, {} };

// Player body (64x64). Its riding anim (gUnknown_0840AE80) is applied by the bike-ride task.
static const struct OamData sOamData_PlayerBody = { .y = 160, .shape = ST_OAM_SQUARE, .size = 3, .priority = 1 };
static const union AnimCmd sAnim_PlayerBody[] = { ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(64, 8), ANIMCMD_FRAME(128, 8), ANIMCMD_FRAME(192, 8), ANIMCMD_JUMP(0) };
static const union AnimCmd *const sAnims_PlayerBody[] = { sAnim_PlayerBody };
static const struct SpriteTemplate sSpriteTemplate_BrendanBody = { RS_TAG_BRENDAN, RS_TAG_BRENDAN, &sOamData_PlayerBody, sAnims_PlayerBody, NULL, gDummySpriteAffineAnimTable, SpriteCallbackDummy };
static const struct SpriteTemplate sSpriteTemplate_MayBody     = { RS_TAG_MAY, RS_TAG_MAY, &sOamData_PlayerBody, sAnims_PlayerBody, NULL, gDummySpriteAffineAnimTable, SpriteCallbackDummy };

// Bicycle (64x32) follows the player body.
static void SpriteCB_IntroBicycle(struct Sprite *sprite)
{
...
static const struct OamData sOamData_Bicycle = { .y = 160, .shape = ST_OAM_H_RECTANGLE, .size = 3, .priority = 1 };
static const union AnimCmd sAnim_Bicycle[] = { ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(32, 8), ANIMCMD_FRAME(64, 8), ANIMCMD_FRAME(96, 8), ANIMCMD_JUMP(0) };
static const union AnimCmd *const sAnims_Bicycle[] = { sAnim_Bicycle };
static const struct SpriteTemplate sSpriteTemplate_BrendanBike = { RS_TAG_BICYCLE, RS_TAG_BRENDAN, &sOamData_Bicycle, sAnims_Bicycle, NULL, gDummySpriteAffineAnimTable, SpriteCB_IntroBicycle };
static const struct SpriteTemplate sSpriteTemplate_MayBike     = { RS_TAG_BICYCLE, RS_TAG_MAY, &sOamData_Bicycle, sAnims_Bicycle, NULL, gDummySpriteAffineAnimTable, SpriteCB_IntroBicycle };

static u8 intro_create_brendan_sprite(s16 a, s16 b)
{
    u8 body = CreateSprite(&sSpriteTemplate_BrendanBody, a, b, 0);
    u8 bike = CreateSprite(&sSpriteTemplate_BrendanBike, a, b + 8, 1);
    gSprites[bike].data[0] = body;
    return body;
}

static u8 intro_create_may_sprite(s16 a, s16 b)
{
    u8 body = CreateSprite(&sSpriteTemplate_MayBody, a, b, 0);
    u8 bike = CreateSprite(&sSpriteTemplate_MayBike, a, b + 8, 1);
    gSprites[bike].data[0] = body;
    return body;
}

static const u16 gIntro2LatiosPalette[] = INCBIN_U16("graphics/intro_rs/intro2_latios.gbapal");
static const u32 gIntro2LatiosTiles[]   = INCBIN_U32("graphics/intro_rs/intro2_latios.4bpp.lz");
static const u16 gIntro2LatiasPalette[] = INCBIN_U16("graphics/intro_rs/intro2_latias.gbapal");
static const u32 gIntro2LatiasTiles[]   = INCBIN_U32("graphics/intro_rs/intro2_latias.4bpp.lz");
static const struct OamData sOamData_Lati = { .y = 160, .shape = ST_OAM_SQUARE, .size = 3, .priority = 1 };
static const union AnimCmd sAnim_Lati0[] = { ANIMCMD_FRAME(0, 16), ANIMCMD_END };
static const union AnimCmd sAnim_Lati1[] = { ANIMCMD_FRAME(64, 16), ANIMCMD_END };
static const union AnimCmd *const sAnims_Lati[] = { sAnim_Lati0, sAnim_Lati1 };
static void nullsub_83(struct Sprite *sprite) {}
static void sub_81493C4(struct Sprite *sprite)
{
    sprite->invisible = gSprites[sprite->data[0]].invisible;
...
static const struct SpriteTemplate sSpriteTemplate_Latios = { RS_TAG_LATIOS, RS_TAG_LATIOS, &sOamData_Lati, sAnims_Lati, NULL, gDummySpriteAffineAnimTable, nullsub_83 };
static const struct SpriteTemplate sSpriteTemplate_Latias = { RS_TAG_LATIAS, RS_TAG_LATIAS, &sOamData_Lati, sAnims_Lati, NULL, gDummySpriteAffineAnimTable, nullsub_83 };
static const struct CompressedSpriteSheet sSpriteSheet_Latios[] = { { gIntro2LatiosTiles, 0x1000, RS_TAG_LATIOS }, {} };
static const struct CompressedSpriteSheet sSpriteSheet_Latias[] = { { gIntro2LatiasTiles, 0x1000, RS_TAG_LATIAS }, {} };
static const struct SpritePalette sSpritePalettes_Lati[] = { { gIntro2LatiosPalette, RS_TAG_LATIOS }, { gIntro2LatiasPalette, RS_TAG_LATIAS }, {} };

static u8 intro_create_latios_sprite(s16 a, s16 b)
{
    u8 sprite = CreateSprite(&sSpriteTemplate_Latios, a - 32, b, 2);
    u8 latios = CreateSprite(&sSpriteTemplate_Latios, a + 32, b, 2);
...
static u8 intro_create_latias_sprite(s16 a, s16 b)
{
    u8 sprite = CreateSprite(&sSpriteTemplate_Latias, a - 32, b, 2);
    u8 latias = CreateSprite(&sSpriteTemplate_Latias, a + 32, b, 2);
    gSprites[latias].data[0] = sprite;
    StartSpriteAnim(&gSprites[latias], 1);
    gSprites[latias].callback = sub_81493C4;
    return sprite;
}
...
static void Task_IntroLoadPart2Graphics(u8 taskId)
{
    ...
    gUnknown_02039358 = 0;
    gUnknown_0203935A = 0;
    if (gIntroPairIndex == SAPPHIRE_PAIR)
...
static void Task_IntroStartBikeRide(u8 taskId)
{
    ...
    LoadCompressedSpriteSheet(sSpriteSheet_Bicycle);
    if (gIntroPairIndex == SAPPHIRE_PAIR)
        LoadCompressedSpriteSheet(sSpriteSheet_Latias);
    else
        LoadCompressedSpriteSheet(sSpriteSheet_Latios);
    LoadSpritePalettes(sSpritePalettes_Player);
    LoadSpritePalettes(sSpritePalettes_Lati);
    if (gUnknown_02039318 == 0)
...
static void Task_IntroPokemonBattle(u8 taskId)
{
    ...
    if (sIntroFrameCounter == 800)
        PlaySE(SE_INTRO_BLAST);
    if (sIntroFrameCounter == 850)
        BeginNormalPaletteFade(0xFFFFFFFF, 4, 0, 16, FADE_COLOR_WHITE);
    if (sIntroFrameCounter == 946)
...
static u16 sub_813CE88(u16 species, s16 x, s16 y, u16 d, u8 front)
{
    ...
    if (front)
        LoadSpecialPokePic(&gMonFrontPicTable[species], PIC_BUFFER(d), species, 0, TRUE);
    else
        LoadSpecialPokePic(&gMonBackPicTable[species], PIC_BUFFER(d), species, 0, FALSE);
    lzPaletteData = GetMonSpritePalFromSpeciesAndPersonality(species, 0, 0xFFFF);
    LoadCompressedPalette(lzPaletteData, OBJ_PLTT_ID(d), PLTT_SIZE_4BPP);
    ...
    gCreatingSpriteTemplate.anims = sIntroPicAnims;
...
static void sub_813D788(struct Sprite *sprite)
{
    ...
    case 1:
        StartSpriteAnimIfDifferent(sprite, 0);
        if (sIntroFrameCounter & 7)
            return;
        sprite->x++;
        break;
    case 2:
        StartSpriteAnimIfDifferent(sprite, 2);
        if (sprite->x <= 120 || (sIntroFrameCounter & 7))
            sprite->x++;
        break;
    case 3:
