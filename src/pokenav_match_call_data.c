...
static const match_call_text_data_t sCollectorCorbeauTextScripts[] = {
    { gText_CollectorCorbeauIntro,  0xFFFE, FLAG_ENABLE_CORBEAU_MATCH_CALL },
...
static const struct MatchCallStructNPC sCollectorCorbeauMatchCallHeader =
{
    .type = MC_TYPE_NPC,
    .mapSec = MAPSEC_NONE,
    .flag = FLAG_ENABLE_CORBEAU_MATCH_CALL,
    .desc = gText_CollectorCorbeauMatchCallDesc,
    .name = gText_CollectorCorbeauMatchCallName,
    .textData = sCollectorCorbeauTextScripts
};
...
static const match_call_t sMatchCallHeaders[] = {
    ...
    [MC_HEADER_POKEMON_CENTER_NURSE]   = {.npc    = &sCollectorCorbeauMatchCallHeader}
};
