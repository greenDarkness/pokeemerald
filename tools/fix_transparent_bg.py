...
if bg_index != 0:
    ...
    img.putdata(pixels)
    img.save('graphics/object_events/pics/pokemon/meowth_npc1pal_trans.png')
    print('Wrote graphics/object_events/pics/pokemon/meowth_npc1pal_trans.png with background set to index 0')
else:
    print('Background is already index 0, no change made.')
